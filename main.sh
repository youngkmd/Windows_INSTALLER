		  ...
		  while true; do
			...
			case "$sys_choice" in
			  ...
			  44)
				...
				dd_xitong_2
				bash InstallNET.sh -windows 2025 -lang "en"
				reboot
				exit
				;;
			  ...
			  45)
				...
				dd_xitong_2
				bash InstallNET.sh -windows 2022 -lang "en"
				reboot
				exit
				;;
			  ...
			  46)
				...
				dd_xitong_2
				bash InstallNET.sh -windows 2019 -lang "en"
				reboot
				exit
				;;
...
echo "╩ ╩╚═╝╚╝╩╩═╝╩╚═╝╝╚╝o╚═╝╩ ╩"
echo -e "${NC}"
echo -e "${GREEN}Technology lion script toolbox v$sh_v${NC}"
echo -e "${YELLOW}KADER INSTALLER${NC}"
echo "==============================="
